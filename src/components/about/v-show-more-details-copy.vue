...
export default {
  data: () => ({
    show: false,
    card_text:
      "Працюю оператором з виробництва пластикових карт (внутрішній паспорт, закордонний паспорт, водійські посвідчення, Visa або Mastercard і ін.). Робота бригадна в кількості п'ять чоловік в зміні на лінії.",
  }),
};
</script>
<style scoped>
