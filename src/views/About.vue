                  ...
                  <v-alert elevation="14" class="hidden-sm-and-down">
                    ...
                    >
                      ...
                      <h4>
                        ...
                        облдержадміністрація), старший державний податковий
                        ревізор- інспектор відділу податкового контролю
                        юридичних осіб (Державна податкова інспекція),
                        cпеціаліст по виплаті (Управління праці та соціального
                        захисту населення).
                        <vHoverOff />
                      </h4> </v-timeline-item
                  ></v-alert>
              ...
              <v-card-text>
                <v-alert elevation="14">
                  <h4>
                    ...
                    Приазовья. (066)-725-62-51, nik.tam03@icloud.com м. Київ
                    пров. Балтійський
